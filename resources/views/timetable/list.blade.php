    ...
    <div class="wrap">
        ...
        <div class="day">
            ...
            @foreach ($time as $item)
                ...
                <div class="day-time">
                    ...
                    <a class="btn btn-danger" href="{{route('timetabledelete', $item['id'])}}">Удалить</a>
                </div>
                @endif
            @endforeach
            <a class="btn btn-primary" href="{{route('timetablecreate', ['room' => $room, 'day' => 1])}}">Создать новое занятие</a>
        </div>
        <div class="day">
            ...
            @foreach ($time as $item)
                ...
                @endif
            @endforeach
            <a class="btn btn-primary" href="{{route('timetablecreate', ['room' => $room, 'day' => 2])}}">Создать новое занятие</a>
        </div>
        <div class="day">
           ...
           @foreach ($time as $item)
                ...
                @endif
            @endforeach
            <a class="btn btn-primary" href="{{route('timetablecreate', ['room' => $room, 'day' => 3])}}">Создать новое занятие</a>
        </div>
        <div class="day">
            ...
            @foreach ($time as $item)
                ...
                @endif
            @endforeach
            <a class="btn btn-primary" href="{{route('timetablecreate', ['room' => $room, 'day' => 4])}}">Создать новое занятие</a>
        </div>
        <div class="day">
            ...
            @foreach ($time as $item)
                ...
                @endif
            @endforeach
            <a class="btn btn-primary" href="{{route('timetablecreate', ['room' => $room, 'day' => 5])}}">Создать новое занятие</a>
        </div>
        ...
        <div class="day">
            ...
            @foreach ($time as $item)
                ...
                @endif
            @endforeach
            <a class="btn btn-primary" href="{{route('timetablecreate', ['room' => $room, 'day' => 6])}}">Создать новое занятие</a>
        </div>
        <div class="day">
            ...
            @foreach ($time as $item)
                ...
                @endif
            @endforeach
            <a class="btn btn-primary" href="{{route('timetablecreate', ['room' => $room, 'day' => 7])}}">Создать новое занятие</a>
        </div>
    </div>
@endsection
<style>
